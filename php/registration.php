...
<body>
  <main>
    ...
    <container>
      <div>
        <img class="planning-img" src="../img/profiling.svg" alt="login img">
      </div>
      <?php
  ...
  <input class="form-row" type="username" id="username" name="username" placeholder="  Text your full name here" ><br>
